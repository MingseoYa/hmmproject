...
exports.soundlist = (req, res) => {
    ...
    db.query('select NickName, Path, Users.ProfileImg from Video, Users where Video.UserPKey = Users.PKey and Video.UploadType = ?', [sound], async(error, results) => {
        ...
        for(var data of results){//한줄만 뽑히잖니';;;;;경로, 유저키
            ...
            datanickname = data.NickName;
            profileImg = data.ProfileImg;
            pnu.push(profileImg, datanickname, datapath);
